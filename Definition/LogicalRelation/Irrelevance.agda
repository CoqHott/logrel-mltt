...
mutual
  ...
  irrelevanceEqT (ne (ne K D neK _) (ne K₁ D₁ neK₁ K≡K₁)) (ne₌ M D′ neM K≡M)
    ...
    ne₌ M D′ neM K≡M
  irrelevanceEqT {Γ} {r = r} (Πᵥ (Πᵣ rF lF lG _ _ F G D nf ⊢F ⊢G A≡A [F] [G] G-ext)
                         (Πᵣ rF₁ lF₁ lG₁ _ _ F₁ G₁ D₁ nf₁ ⊢F₁ ⊢G₁ A≡A₁ [F]₁ [G]₁ G-ext₁))
                 (Π₌ F′ G′ D′ nf′ A≡B [F≡F′] [G≡G′]) =
    let ΠFG≡ΠF₁G₁   = whrDet* (red D , nf) (red D₁ , nf₁)
        F≡F₁ , rF≡rF₁ , lF≡lF₁ , G≡G₁ , lG≡lG₁ , lΠ≡lΠ₁ , rΠ≡rΠ₁ = Π-PE-injectivity ΠFG≡ΠF₁G₁
    in  Π₌ F′ G′ (PE.subst₃ _ rF≡rF₁ lF≡lF₁ lG≡lG₁ D′) (PE.subst₃ _ rF≡rF₁ lF≡lF₁ lG≡lG₁ nf′)
  ...
  irrelevanceEqT {Γ} {r = r} (Πirrᵥ (Πirrᵣ rF lF F G D nf ⊢F ⊢G A≡A)
                         (Πirrᵣ rF₁ lF₁ F₁ G₁ D₁ nf₁ ⊢F₁ ⊢G₁ A≡A₁))
                 (Πirr₌ F′ G′ D′ nf′ A≡B) =
    let ΠFG≡ΠF₁G₁   = whrDet* (red D , nf) (red D₁ , nf₁)
        F≡F₁ , rF≡rF₁ , lF≡lF₁ , G≡G₁ , lG≡lG₁ , lΠ≡lΠ₁ , _ = Π-PE-injectivity ΠFG≡ΠF₁G₁
    in  Πirr₌ F′ G′ (PE.subst₂ _ rF≡rF₁ lF≡lF₁ D′) (PE.subst₂ _ rF≡rF₁ lF≡lF₁ nf′)
        (PE.subst5 (λ x rx lx lx' lx'' → Γ ⊢ x ≅ Π F′ ^ rx ° lx ▹ G′ ° lx' ° lx'' ^ % ^ r) ΠFG≡ΠF₁G₁ rF≡rF₁ lF≡lF₁ lG≡lG₁ lΠ≡lΠ₁ A≡B)
  irrelevanceEqT {Γ} {r = r} (Idᵥ (Idᵣ F t u _ D nf ⊢F ⊢t ⊢u A≡A)
                         (Idᵣ F₁ t' u' _ D₁ nf₁ ⊢F₁ ⊢t' ⊢u' A≡A₁))
                 (Id₌ F′ t′ u′ D′ nf′ A≡B) =
    let IdFG≡IdF₁G₁   = whrDet* (red D , nf) (red D₁ , nf₁)
        F≡F₁ , t≡t' , u≡u' = Id-PE-injectivity IdFG≡IdF₁G₁
    in  Id₌ F′ t′ u′ D′ nf′ (PE.subst (λ x → Γ ⊢ x ≅ Id F′ t′ u′ ^ r) IdFG≡IdF₁G₁ A≡B)
  ...
  irrelevance-level l< (Πᵣ′ rF lF lG lF≤ lG≤ F G D nf ⊢F ⊢G A≡A [F] [G] G-ext) = Πᵣ′ rF lF lG lF≤ lG≤ F G D nf ⊢F ⊢G A≡A (λ x ⊢Δ → irrelevance-level l< ([F] x ⊢Δ ))
  ...
  irrelevance-level l< (Πirrᵣ′ rF lF F G D nf ⊢F ⊢G A≡A) = Πirrᵣ′ rF lF F G D nf ⊢F ⊢G A≡A 
  irrelevance-level l< (Idᵣ′ F t u l D nf ⊢F ⊢t ⊢u A≡A) = Idᵣ′ F t u l D nf ⊢F ⊢t ⊢u A≡A
...
--------------------------------------------------------------------------------
  ...
  irrelevanceTermT {r = [ % , ll ]} (ne (ne K D neK K≡K) (ne .K D₁ neK₁ K≡K₁)) (neₜ d)
    | PE.refl = neₜ d
  irrelevanceTermT {Γ} {t = t} {r = [ ! , ll ]} (Πᵥ (Πᵣ rF lF lG _ _ F G D nf ⊢F ⊢G A≡A [F] [G] G-ext)
                                   (Πᵣ rF₁ lF₁ lG₁ _ _ F₁ G₁ D₁ nf₁ ⊢F₁ ⊢G₁ A≡A₁ [F]₁ [G]₁ G-ext₁))
  ...
  irrelevanceTermT {Γ} {t = t} {r = [ % , ll ]} (Πirrᵥ (Πirrᵣ rF lF F G D nf ⊢F ⊢G A≡A)
                                   (Πirrᵣ rF₁ lF₁ F₁ G₁ D₁ nf₁ ⊢F₁ ⊢G₁ A≡A₁))
                  d = let ΠFG≡ΠF₁G₁   = whrDet* (red D , nf) (red D₁ , nf₁)
                       in PE.subst (λ x → Γ ⊢ t ∷ x ^ [ % , ll ]) ΠFG≡ΠF₁G₁ d
  irrelevanceTermT {Γ} {t = t} {r = [ % , ll ]} (Idᵥ (Idᵣ F tt u _ D nf ⊢F ⊢t ⊢u A≡A)
                                   (Idᵣ F₁ t' u' _ D₁ nf₁ ⊢F₁ ⊢t' ⊢u' A≡A₁))
                   d = let IdFG≡IdF₁G₁ = whrDet* (red D , nf) (red D₁ , nf₁)
...
--------------------------------------------------------------------------------
  ...
  irrelevanceEqTermT {Γ} {t = t} {u = u} {r = [ ! , ll ]}
                     (Πᵥ (Πᵣ rF lF lG lF≤ lG≤ F G D nf ⊢F ⊢G A≡A [F] [G] G-ext)
                         (Πᵣ rF₁ lF₁ lG₁ lF₁≤ lG₁≤ F₁ G₁ D₁ nf₁ ⊢F₁ ⊢G₁ A≡A₁ [F]₁ [G]₁ G-ext₁))
                     (Πₜ₌ f g d d′ funcF funcG f≡g [f] [g] [f≡g]) =
    let ΠFG≡ΠF₁G₁   = whrDet* (red D , nf) (red D₁ , nf₁)
        F≡F₁ , rF≡rF₁ , lF≡lF₁ , G≡G₁ , lG≡lG₁ , lΠ≡lΠ₁ = Π-PE-injectivity ΠFG≡ΠF₁G₁
        [A]         = Πᵣ′ rF lF lG lF≤ lG≤ F G D nf ⊢F ⊢G A≡A [F] [G] G-ext
        [A]₁        = Πᵣ′ rF₁ lF₁ lG₁ lF₁≤ lG₁≤ F₁ G₁ D₁ nf₁ ⊢F₁ ⊢G₁ A≡A₁ [F]₁ [G]₁ G-ext₁
  ...
  irrelevanceEqTermT {Γ} {t = t} {u = u} {r = [ % , ll ]}
                     (Πirrᵥ (Πirrᵣ rF lF F G D nf ⊢F ⊢G A≡A)
                         (Πirrᵣ rF₁ lF₁ F₁ G₁ D₁ nf₁ ⊢F₁ ⊢G₁ A≡A₁))
                     (d , d′) = let ΠFG≡ΠF₁G₁ = whrDet* (red D , nf) (red D₁ , nf₁) in
                                (PE.subst (λ x → Γ ⊢ t ∷ x ^ [ % , ll ]) ΠFG≡ΠF₁G₁ d , PE.subst (λ x → Γ ⊢ u ∷ x ^ [ % , ll ]) ΠFG≡ΠF₁G₁ d′)
  irrelevanceEqTermT {Γ} {t = t} {u = u} {r = [ % , ll ]}
                     (Idᵥ (Idᵣ F tt uu _ D nf ⊢F ⊢t ⊢u A≡A)
                         (Idᵣ F₁ t' u' _ D₁ nf₁ ⊢F₁ ⊢t' ⊢u' A≡A₁))
                     (d , d′) = let IdFG≡IdF₁G₁ = whrDet* (red D , nf) (red D₁ , nf₁) in
