...
[cast] {A} {B} {t} {e} {Γ} ⊢Γ (Πᵣ′ ! .⁰ .⁰ (≡is≤ PE.refl) (≡is≤ PE.refl) F G [[ ⊢A , ⊢ΠFG , D ]] ⊢F ⊢G A≡A [F] [G] G-ext)
  ...
  let
    ...
    [b] [ρ] ⊢Δ ⊢e [x] = 
      ...
      in [cast] ⊢Δ ([F₁] [ρ] ⊢Δ) {!!} [x] ⊢e′ --  [cast] ⊢Δ ([F₁] [ρ] ⊢Δ) ([F] [ρ] ⊢Δ) [x]  ⊢e′ -- 
    ...
    [g] {ρ} {Δ} {x} [ρ] ⊢Δ [x] =
      let
        ...
        [t] = 
          proj₁ (redSubst*Term (appRed* (escapeTerm ([F] [ρ] ⊢Δ) [b]) (Twk.wkRed*Term [ρ] ⊢Δ Df))
            ([G] [ρ] ⊢Δ [b]) ([f] [ρ] ⊢Δ [b]))
