...
natrec-subst* C c g (id x) [ℕ] [n′] prop = id (natrecⱼ (λ x → ⊥-elim (!≢% x)) C c g x)
...
sucCase₂' : ∀ {F Γ l lF}
           ([Γ] : ⊩ᵛ Γ)
           ([ℕ] : Γ ⊩ᵛ⟨ l ⟩ ℕ ^ [ ! , ι ⁰ ] / [Γ])
           ([F] : Γ ∙ ℕ ^ [ ! , ι ⁰ ] ⊩ᵛ⟨ l ⟩ F ^ [ ! , ι lF ] / [Γ] ∙ [ℕ])
         → Γ ⊩ᵛ⟨ l ⟩ Π ℕ ^ ! ° ⁰ ▹ F [ suc (var 0) ]↑ ° lF ° lF ^ ! ^ [ ! , ι lF ] / [Γ]
sucCase₂' {F} {Γ} {l} {lF} [Γ] [ℕ] [F] =  Πᵛ {ℕ} {F [ suc (var 0) ]↑} (⁰min lF) (≡is≤ PE.refl) [Γ] [ℕ]
     (sucCase₂ {F} [Γ] [ℕ] [F])
...
sucCase₁ : ∀ {F rF Γ l lF}
         ...
         → Γ ∙ ℕ ^ [ ! , ι ⁰ ] ⊩ᵛ⟨ l ⟩ F ^ rF ° lF ▹▹ F [ suc (var 0) ]↑ ° lF ° lF ^ rF ^ [ rF , ι lF ] / [Γ] ∙ [ℕ]
sucCase₁ {F} {rF = !} {Γ} {l} _ [Γ] [ℕ] [F] =
  ▹▹ᵛ {F} {F [ suc (var 0) ]↑} (≡is≤ PE.refl) (≡is≤ PE.refl) (_∙_ {A = ℕ} [Γ] [ℕ]) [F]
      (sucCase₂ {F} [Γ] [ℕ] [F])
sucCase₁ {F} {rF = %} {Γ} {l} {lF = ⁰} _ [Γ] [ℕ] [F] =
  ▹▹irrᵛ {F} {F [ suc (var 0) ]↑} (_∙_ {A = ℕ} [Γ] [ℕ]) [F] (sucCase₂ {F} [Γ] [ℕ] [F])
sucCase₁ {F} {rF = %} {Γ} {l} {lF = ¹} rFlF [Γ] [ℕ] [F] = ⊥-elim (⁰≢¹ (PE.sym (rFlF PE.refl)))
...
sucCase : ∀ {F rF Γ l lF}
          ...
          ([ℕ] : Γ ⊩ᵛ⟨ l ⟩ ℕ ^ [ ! , ι ⁰ ] / [Γ])
          ([F] : Γ ∙ ℕ ^ [ ! , ι ⁰ ] ⊩ᵛ⟨ l ⟩ F ^ [ rF , ι lF ] / [Γ] ∙ [ℕ])
        → Γ ⊩ᵛ⟨ l ⟩ Π ℕ ^ ! ° ⁰ ▹ (F ^ rF ° lF ▹▹ F [ suc (var 0) ]↑ ° lF ° lF ^ rF) ° lF ° lF ^ rF ^ [ rF , ι lF ] / [Γ]
sucCase {F} {rF = !} {Γ} {l} {lF} rFlF [Γ] [ℕ] [F] =
  Πᵛ {ℕ} {F ^ ! ° lF ▹▹ F [ suc (var 0) ]↑ ° lF ° lF ^ !} (⁰min lF) (≡is≤ PE.refl) [Γ] [ℕ]
     (sucCase₁ {F} rFlF [Γ] [ℕ] [F])
sucCase {F} {rF = %} {Γ} {l} {lF = ⁰} rFlF [Γ] [ℕ] [F] =
  Πirrᵛ {ℕ} {F ^ % ° ⁰ ▹▹ F [ suc (var 0) ]↑ ° ⁰ ° ⁰ ^ %} [Γ] [ℕ] (sucCase₁ {F} rFlF [Γ] [ℕ] [F])
sucCase {F} {rF = %} {Γ} {l} {lF = ¹} rFlF [Γ] [ℕ] [F] = ⊥-elim (⁰≢¹ (PE.sym (rFlF PE.refl)))


-- Construct a valid type equality for the successor case of natrec.
sucCaseCong : ∀ {F F′ rF Γ l lF}
              (rFlF : rF PE.≡ % → lF PE.≡ ⁰)
              ([Γ] : ⊩ᵛ Γ)
              ([ℕ] : Γ ⊩ᵛ⟨ l ⟩ ℕ ^ [ ! , ι ⁰ ] / [Γ])
              ([F] : Γ ∙ ℕ ^ [ ! , ι ⁰ ] ⊩ᵛ⟨ l ⟩ F ^ [ rF , ι lF ] / [Γ] ∙ [ℕ])
        ...
        → Γ ⊩ᵛ⟨ l ⟩ Π ℕ ^ ! ° ⁰ ▹ (F ^ rF ° lF ▹▹ F  [ suc (var 0) ]↑ ° lF ° lF ^ rF) ° lF ° lF ^ rF
                  ≡ Π ℕ ^ ! ° ⁰ ▹ (F′ ^ rF ° lF ▹▹ F′ [ suc (var 0) ]↑ ° lF ° lF ^ rF) ° lF ° lF ^ rF ^ [ rF , ι lF ]
                  / [Γ] / sucCase {F} rFlF [Γ] [ℕ] [F]
sucCaseCong {F} {F′} {rF = !} {Γ} {l} {lF} rFlF [Γ] [ℕ] [F] [F′] [F≡F′] =
  Π-congᵛ {ℕ} {F ^ ! ° lF ▹▹ F [ suc (var 0) ]↑ ° lF ° lF ^ !} {ℕ} {F′ ^ ! ° lF ▹▹ F′ [ suc (var 0) ]↑ ° lF ° lF ^ !}
          (⁰min lF) (≡is≤ PE.refl) [Γ] [ℕ] (sucCase₁ {F} rFlF [Γ] [ℕ] [F]) [ℕ] (sucCase₁ {F′} rFlF [Γ] [ℕ] [F′])
          (reflᵛ {ℕ} [Γ] [ℕ])
...
sucCaseCong {F} {F′} {rF = %} {Γ} {l} {lF = ⁰} rFlF [Γ] [ℕ] [F] [F′] [F≡F′] =
  Πirr-congᵛ {ℕ} {F ^ % ° ⁰ ▹▹ F [ suc (var 0) ]↑ ° ⁰ ° ⁰ ^ %} {ℕ} {F′ ^ % ° ⁰ ▹▹ F′ [ suc (var 0) ]↑ ° ⁰ ° ⁰ ^ %}
          [Γ] [ℕ] (sucCase₁ {F} rFlF [Γ] [ℕ] [F]) [ℕ] (sucCase₁ {F′} rFlF [Γ] [ℕ] [F′])
          (reflᵛ {ℕ} [Γ] [ℕ])
          (▹▹irr-congᵛ {F} {F′} {F [ suc (var 0) ]↑} {F′ [ suc (var 0) ]↑} 
             (_∙_ {A = ℕ} [Γ] [ℕ]) [F] [F′] [F≡F′]
             (sucCase₂ {F} [Γ] [ℕ] [F]) (sucCase₂ {F′} [Γ] [ℕ] [F′])
             (subst↑SEq {ℕ} {F} {F′} {suc (var 0)} {suc (var 0)}
                        [Γ] [ℕ] [F] [F′] [F≡F′]
...
sucCaseCong {F} {F′} {rF = %} {Γ} {l} {lF = ¹} rFlF [Γ] [ℕ] [F] [F′] [F≡F′] = ⊥-elim (⁰≢¹ (PE.sym (rFlF PE.refl)))

-- Reducibility of natural recursion under a valid substitution.
natrecTerm : ∀ {F rF lF z s n Γ Δ σ l}
             (rFlF : rF PE.≡ % → lF PE.≡ ⁰)
             ([Γ]  : ⊩ᵛ Γ)
             ([F]  : Γ ∙ ℕ ^ [ ! , ι ⁰ ] ⊩ᵛ⟨ l ⟩ F ^ [ rF , ι lF ] / _∙_ {l = l} [Γ] (ℕᵛ [Γ]))
             ([F₀] : Γ ⊩ᵛ⟨ l ⟩ F [ zero ] ^ [ rF , ι lF ] / [Γ])
             ([F₊] : Γ ⊩ᵛ⟨ l ⟩ Π ℕ ^ ! ° ⁰ ▹ (F ^ rF ° lF ▹▹ F [ suc (var 0) ]↑ ° lF ° lF ^ rF) ° lF ° lF ^ rF ^ [ rF , ι lF ] / [Γ])
             ([z]  : Γ ⊩ᵛ⟨ l ⟩ z ∷ F [ zero ] ^ [ rF , ι lF ] / [Γ] / [F₀])
             ([s]  : Γ ⊩ᵛ⟨ l ⟩ s ∷ Π ℕ ^ ! ° ⁰ ▹ (F ^ rF ° lF ▹▹ F [ suc (var 0) ]↑ ° lF ° lF ^ rF) ° lF ° lF ^ rF ^ [ rF , ι lF ]
                       / [Γ] / [F₊])
             (⊢Δ   : ⊢ Δ)
             ([σ]  : Δ ⊩ˢ σ ∷ Γ / [Γ] / ⊢Δ)
           ...
           → Δ ⊩⟨ l ⟩ natrec lF (subst (liftSubst σ) F) (subst σ z) (subst σ s) n
               ...
               / irrelevance′ (PE.sym (singleSubstComp n σ F))
                              (proj₁ ([F] ⊢Δ ([σ] , [σn])))
natrecTerm {F} {rF = !} {lF} {z} {s} {n} {Γ} {Δ} {σ} {l} rFlF [Γ] [F] [F₀] [F₊] [z] [s] ⊢Δ [σ]
           (ℕₜ .(suc m) d n≡n (sucᵣ {m} [m])) =
  let [ℕ] = ℕᵛ {l = l} [Γ]
      [σℕ] = proj₁ ([ℕ] ⊢Δ [σ])
      ⊢ℕ = escape (proj₁ ([ℕ] ⊢Δ [σ]))
      ⊢F = escape (proj₁ ([F] (⊢Δ ∙ ⊢ℕ) (liftSubstS {F = ℕ} [Γ] ⊢Δ [ℕ] [σ])))
      ⊢z = PE.subst (λ x → _ ⊢ _ ∷ x ^ [ ! , ι lF ]) (singleSubstLift F zero)
                    (escapeTerm (proj₁ ([F₀] ⊢Δ [σ])) (proj₁ ([z] ⊢Δ [σ])))
      ⊢s = PE.subst (λ x → Δ ⊢ subst σ s ∷ x ^ [ ! , ι lF ]) (natrecSucCase σ F ! lF)
                    (escapeTerm (proj₁ ([F₊] ⊢Δ [σ])) (proj₁ ([s] ⊢Δ [σ])))
      ⊢m = escapeTerm {l = l} [σℕ] [m]
      [σsm] = irrelevanceTerm {l = l} (ℕᵣ (idRed:*: (univ (ℕⱼ ⊢Δ)))) [σℕ]
      ...
      [Fₙ≡Fₛₘ] = irrelevanceEq″ (PE.sym (singleSubstComp n σ F))
                                 (PE.sym (singleSubstComp (suc m) σ F)) PE.refl PE.refl
                                 [σFₙ]′ [σFₙ]
                                 (proj₂ ([F] ⊢Δ ([σ] , [σn])) ([σ] , [σsm])
      ...
      [FF] = proj₁ (sucCase₁ {F = F} rFlF [Γ] [ℕ] [F] (⊢Δ ∙ ⊢ℕ) (liftSubstS {F = ℕ} [Γ] ⊢Δ [ℕ] [σ]))
      natrecM = appTerm PE.refl [σFₘ] [σFₛₘ]′ [σF₊ₘ]
                        (appTerm PE.refl [σℕ] [σF₊ₘ]
                                 (proj₁ ([F₊] ⊢Δ [σ]))
                                 (proj₁ ([s] ⊢Δ [σ])) [m] (un-univ (escape [FF])))
                        (natrecTerm {F} { ! } {lF} {z} {s} {m} {σ = σ} rFlF
                                    [Γ] [F] [F₀] [F₊] [z] [s] ⊢Δ [σ] [m]) (un-univ (escape (decompΠ [σF₊ₘ] [σFₘ])))
...
natrecTerm {F} {rF = %} {lF} {z} {s} {n} {Γ} {Δ} {σ} {l} rFlF [Γ] [F] [F₀] [F₊] [z] [s] ⊢Δ [σ]
  ...
  let [ℕ] = ℕᵛ {l = l} [Γ]
      ...
      ⊢ℕ = escape (proj₁ ([ℕ] ⊢Δ [σ]))
      ⊢F = escape (proj₁ ([F] (⊢Δ ∙ ⊢ℕ) (liftSubstS {F = ℕ} [Γ] ⊢Δ [ℕ] [σ])))
      ⊢z = PE.subst (λ x → _ ⊢ _ ∷ x ^ [ % , _ ]) (singleSubstLift F zero)
                    (escapeTerm (proj₁ ([F₀] ⊢Δ [σ])) (proj₁ ([z] ⊢Δ [σ])))
      ⊢s = PE.subst (λ x → Δ ⊢ subst σ s ∷ x ^ [ % , ι lF ]) (natrecSucCase σ F % lF)
                    (escapeTerm (proj₁ ([F₊] ⊢Δ [σ])) (proj₁ ([s] ⊢Δ [σ])))
      ⊢m = escapeTerm {l = l} [σℕ] [m]
      ...
      [σFₙ] = irrelevance′ (PE.sym (singleSubstComp n σ F)) [σFₙ]′
      [[ ⊢n , _ , _ ]] = d
  in logRelIrr [σFₙ] (natrecⱼ rFlF ⊢F ⊢z ⊢s ⊢n)
...
natrecTerm {F} {rF = !} {lF} {z} {s} {n} {Γ} {Δ} {σ} {l} rFlF [Γ] [F] [F₀] [F₊] [z] [s] ⊢Δ [σ]
  ...
  let [ℕ] = ℕᵛ {l = l} [Γ]
      ...
      ⊢s = PE.subst (λ x → Δ ⊢ subst σ s ∷ x ^ [ ! , ι lF ]) (natrecSucCase σ F ! lF)
                    (escapeTerm (proj₁ ([F₊] ⊢Δ [σ])) (proj₁ ([s] ⊢Δ [σ])))
      [σ0] = irrelevanceTerm {l = l} (ℕᵣ (idRed:*: (univ (ℕⱼ ⊢Δ)))) [σℕ]
      ...
      [Fₙ≡F₀]″ = irrelevanceEq″ (PE.sym (singleSubstComp n σ F))
                                  (PE.trans (substConcatSingleton′ F)
                                            (PE.sym (singleSubstComp zero σ F))) PE.refl PE.refl 
                                  [σFₙ]′ [σFₙ] [Fₙ≡F₀]′
      [σz] = proj₁ ([z] ⊢Δ [σ])
...
natrecTerm {F} {rF = !} {lF} {z} {s} {n} {Γ} {Δ} {σ} {l} rFlF [Γ] [F] [F₀] [F₊] [z] [s] ⊢Δ [σ]
  ...
  let [ℕ] = ℕᵛ {l = l} [Γ]
      ...
      ⊢z = PE.subst (λ x → _ ⊢ _ ∷ x ^ [ ! , _ ]) (singleSubstLift F zero)
                    (escapeTerm (proj₁ ([F₀] ⊢Δ [σ])) (proj₁ ([z] ⊢Δ [σ])))
      ⊢z≡z = PE.subst (λ x → _ ⊢ _ ≅ _ ∷ x ^ [ ! , _ ]) (singleSubstLift F zero)
                      (escapeTermEq (proj₁ ([F₀] ⊢Δ [σ]))
                                        (reflEqTerm (proj₁ ([F₀] ⊢Δ [σ]))
                                                    (proj₁ ([z] ⊢Δ [σ]))))
      ⊢s = PE.subst (λ x → Δ ⊢ subst σ s ∷ x ^ [ ! , ι lF ]) (natrecSucCase σ F ! lF)
                    (escapeTerm (proj₁ ([F₊] ⊢Δ [σ])) (proj₁ ([s] ⊢Δ [σ])))
      ⊢s≡s = PE.subst (λ x → Δ ⊢ subst σ s ≅ subst σ s ∷ x ^ [ ! , ι lF ]) (natrecSucCase σ F ! lF)
                      (escapeTermEq (proj₁ ([F₊] ⊢Δ [σ]))
                                        (reflEqTerm (proj₁ ([F₊] ⊢Δ [σ]))
                                                    (proj₁ ([s] ⊢Δ [σ]))))
      ...
      natrecM = neuTerm [σFₘ] (natrecₙ neM) (natrecⱼ rFlF ⊢F ⊢z ⊢s ⊢m)
...
natrec-congTerm : ∀ {F F′ rF lF z z′ s s′ n m Γ Δ σ σ′ l}
                  (rFlF : rF PE.≡ % → lF PE.≡ ⁰)
                  ([Γ]      : ⊩ᵛ Γ)
                  ([F]      : Γ ∙ ℕ ^ [ ! , ι ⁰ ] ⊩ᵛ⟨ l ⟩ F ^ [ rF , ι lF ] / _∙_ {l = l} [Γ] (ℕᵛ [Γ]))
                  ([F′]     : Γ ∙ ℕ ^ [ ! , ι ⁰ ] ⊩ᵛ⟨ l ⟩ F′ ^ [ rF , ι lF ] / _∙_ {l = l} [Γ] (ℕᵛ [Γ]))
                  ([F≡F′]   : Γ ∙ ℕ ^ [ ! , ι ⁰ ] ⊩ᵛ⟨ l ⟩ F ≡ F′ ^ [ rF , ι lF ] / _∙_ {l = l} [Γ] (ℕᵛ [Γ])
                                    / [F])
                  ([F₀]     : Γ ⊩ᵛ⟨ l ⟩ F [ zero ] ^ [ rF , ι lF ] / [Γ])
                  ([F′₀]    : Γ ⊩ᵛ⟨ l ⟩ F′ [ zero ] ^ [ rF , ι lF ] / [Γ])
                  ([F₀≡F′₀] : Γ ⊩ᵛ⟨ l ⟩ F [ zero ] ≡ F′ [ zero ] ^ [ rF , ι lF ] / [Γ] / [F₀])
                  ([F₊]     : Γ ⊩ᵛ⟨ l ⟩ Π ℕ ^ ! ° ⁰ ▹ (F ^ rF ° lF ▹▹ F [ suc (var 0) ]↑ ° lF ° lF  ^ rF) ° lF ° lF ^ rF ^ [ rF , ι lF ]
                                / [Γ])
                  ([F′₊]    : Γ ⊩ᵛ⟨ l ⟩ Π ℕ ^ ! ° ⁰ ▹ (F′ ^ rF ° lF ▹▹ F′ [ suc (var 0) ]↑ ° lF ° lF ^ rF) ° lF ° lF ^ rF ^ [ rF , ι lF ]
                                / [Γ])
                  ([F₊≡F₊′] : Γ ⊩ᵛ⟨ l ⟩ Π ℕ ^ ! ° ⁰ ▹ (F ^ rF ° lF ▹▹ F [ suc (var 0) ]↑ ° lF ° lF ^ rF) ° lF  ° lF ^ rF
                                ≡ Π ℕ ^ ! ° ⁰ ▹ (F′ ^ rF ° lF ▹▹ F′ [ suc (var 0) ]↑ ° lF ° lF ^ rF) ° lF ° lF ^ rF ^ [ rF , ι lF ]
                                / [Γ] / [F₊])
                  ([z]      : Γ ⊩ᵛ⟨ l ⟩ z ∷ F [ zero ] ^ [ rF , ι lF ] / [Γ] / [F₀])
                  ([z′]     : Γ ⊩ᵛ⟨ l ⟩ z′ ∷ F′ [ zero ] ^ [ rF , ι lF ] / [Γ] / [F′₀])
                ...
                → Δ ⊩⟨ l ⟩ natrec lF (subst (liftSubst σ) F)
                    ...
                    / irrelevance′ (PE.sym (singleSubstComp n σ F))
                                   (proj₁ ([F] ⊢Δ ([σ] , [σn])))
natrec-congTerm {F} {F′} {rF = !} {lF} {z} {z′} {s} {s′} {n} {m} {Γ} {Δ} {σ} {σ′} {l} rFlF
  ...
  let n″≡n′ = suc-PE-injectivity (whrDet*Term (redₜ d₁ , sucₙ) (redₜ d , sucₙ))
      ...
      [σsn′] = irrelevanceTerm {l = l} (ℕᵣ (idRed:*: (univ (ℕⱼ ⊢Δ)))) [σℕ]
      ...
      [Fₙ≡Fₛₙ′] = irrelevanceEq″ (PE.sym (singleSubstComp n σ F))
                                  (PE.sym (singleSubstComp (suc n′) σ F)) PE.refl PE.refl 
                                  [σFₙ]′ [σFₙ]
                                  (proj₂ ([F] ⊢Δ ([σ] , [σn])) ([σ] , [σsn′])
      ...
      natrecN = appTerm PE.refl [σFₙ′] [σFₛₙ′]′ [σF₊ₙ′]
                        (appTerm PE.refl [σℕ] [σF₊ₙ′] (proj₁ ([F₊] ⊢Δ [σ]))
                                 (proj₁ ([s] ⊢Δ [σ])) [n′] (un-univ (escape [FF])))
                        (natrecTerm {F} { ! } {lF} {z} {s} {n′} {σ = σ} rFlF
                                    [Γ] [F] [F₀] [F₊] [z] [s] ⊢Δ [σ] [n′]) (un-univ (escape (decompΠ [σF₊ₙ′] [σFₙ′])))
      ...
      natrecM = appTerm PE.refl [σ′F′ₘ′] [σ′F′ₛₘ′]′ [σ′F′₊ₘ′]
                        (appTerm PE.refl [σ′ℕ] [σ′F′₊ₘ′] (proj₁ ([F′₊] ⊢Δ [σ′]))
                                 (proj₁ ([s′] ⊢Δ [σ′])) [m′] (un-univ (escape [FF′])))
                        (natrecTerm {F′} { ! } {lF} {z′} {s′} {m′} {σ = σ′} rFlF
                                    [Γ] [F′] [F′₀] [F′₊] [z′] [s′] ⊢Δ [σ′] [m′]) (un-univ (escape (decompΠ [σ′F′₊ₘ′] [σ′F′ₘ′])))
                ...
                (app-congTerm [σFₙ′] [σFₛₙ′]′ [σF₊ₙ′]
                  ...
                  (convTerm₂ [σFₙ′] [σ′F′ₘ′] [σFₙ′≡σ′F′ₘ′]
                             (natrecTerm {F′} { ! } {lF} {z′} {s′} {m′} {σ = σ′} rFlF
                                         [Γ] [F′] [F′₀] [F′₊] [z′] [s′]
                                         ⊢Δ [σ′] [m′]))
                  (natrec-congTerm {F} {F′} { ! } {lF} {z} {z′} {s} {s′} {n′} {m′} {σ = σ} rFlF
                                   [Γ] [F] [F′] [F≡F′] [F₀] [F′₀] [F₀≡F′₀]
                                   [F₊] [F′₊] [F₊≡F′₊] [z] [z′] [z≡z′]
                                   [s] [s′] [s≡s′]
                                   ⊢Δ [σ] [σ′] [σ≡σ′] [n′] [m′] [n′≡m′]) (un-univ (escape (decompΠ [σF₊ₙ′] [σFₙ′]))))
...
natrec-congTerm {F} {F′} {rF = %} {lF} {z} {z′} {s} {s′} {n} {m} {Γ} {Δ} {σ} {σ′} {l} rFlF
  ...
  let n″≡n′ = suc-PE-injectivity (whrDet*Term (redₜ d₁ , sucₙ) (redₜ d , sucₙ))
      ...
      [[ ⊢n , _ , _ ]] = d
      [[ ⊢n′ , _ , _ ]] = d′
  in logRelIrrEq [σFₙ] (natrecⱼ rFlF ⊢F ⊢z ⊢s ⊢n) (conv (natrecⱼ rFlF ⊢F′ ⊢z′ ⊢s′ ⊢n′) (sym (≅-eq (escapeEq  [σFₙ] [σFₙ≡σ′F′ₘ]))))
...
natrec-congTerm {F} {F′} {rF = !} {lF} {z} {z′} {s} {s′} {n} {m} {Γ} {Δ} {σ} {σ′} {l} rFlF
  ...
  let [ℕ] = ℕᵛ {l = l} [Γ]
      ...
      ⊢s′ = PE.subst (λ x → Δ ⊢ subst σ′ s′ ∷ x ^ [ ! , ι lF ]) (natrecSucCase σ′ F′ ! lF)
                     (escapeTerm (proj₁ ([F′₊] ⊢Δ [σ′])) (proj₁ ([s′] ⊢Δ [σ′])))
      [σ0] = irrelevanceTerm {l = l} (ℕᵣ (idRed:*: (univ (ℕⱼ ⊢Δ)))) (proj₁ ([ℕ] ⊢Δ [σ]))
                             (ℕₜ zero (idRedTerm:*: (zeroⱼ ⊢Δ)) n≡n zeroᵣ)
      [σ′0] = irrelevanceTerm {l = l} (ℕᵣ (idRed:*: (univ (ℕⱼ ⊢Δ)))) (proj₁ ([ℕ] ⊢Δ [σ′]))
...
natrec-congTerm {F} {F′} {rF = !} {lF} {z} {z′} {s} {s′} {n} {m} {Γ} {Δ} {σ} {σ′} {l} rFlF
  ...
  let n″≡n′ = whrDet*Term (redₜ d₁ , ne x₂) (redₜ d , ne neN′)
      ...
      ⊢z = PE.subst (λ x → _ ⊢ _ ∷ x ^ [ ! , ι lF ]) (singleSubstLift F zero)
                    (escapeTerm (proj₁ ([F₀] ⊢Δ [σ])) (proj₁ ([z] ⊢Δ [σ])))
      ⊢z≡z = PE.subst (λ x → _ ⊢ _ ≅ _ ∷ x ^ [ ! , ι lF ]) (singleSubstLift F zero)
                      (escapeTermEq (proj₁ ([F₀] ⊢Δ [σ]))
                                        (reflEqTerm (proj₁ ([F₀] ⊢Δ [σ]))
                                                    (proj₁ ([z] ⊢Δ [σ]))))
      ⊢s = PE.subst (λ x → Δ ⊢ subst σ s ∷ x ^ [ ! , ι lF ]) (natrecSucCase σ F ! lF)
      ...
      ⊢σz≡σ′z = PE.subst (λ x → _ ⊢ _ ≅ _ ∷ x ^ [ ! , ι lF ]) (singleSubstLift F zero)
                         (escapeTermEq (proj₁ ([F₀] ⊢Δ [σ]))
                                          (proj₂ ([z] ⊢Δ [σ]) [σ′] [σ≡σ′]))
      ...
      natrecN = neuTerm [σFₙ′] (natrecₙ neN′) (natrecⱼ rFlF ⊢F ⊢z ⊢s ⊢n′)
                        (~-natrec ⊢F≡F ⊢z≡z ⊢s≡s n≡n₁)
      natrecM = neuTerm [σ′F′ₘ′] (natrecₙ neM′) (natrecⱼ rFlF ⊢F′ ⊢z′ ⊢s′ ⊢m′)
                        (~-natrec ⊢F′≡F′ ⊢z′≡z′ ⊢s′≡s′ m≡m₁)
      natrecN≡M =
        convEqTerm₂ [σFₙ] [σFₙ′] [Fₙ≡Fₙ′]
          (neuEqTerm [σFₙ′] (natrecₙ neN′) (natrecₙ neM′)
                     (natrecⱼ rFlF ⊢F ⊢z ⊢s ⊢n′)
                     (conv (natrecⱼ rFlF ⊢F′ ⊢z′ ⊢s′ ⊢m′)
...
natrec-congTerm {F} {F′} {rF = %} {lF} {z} {z′} {s} {s′} {n} {m} {Γ} {Δ} {σ} {σ′} {l} rFlF 
  ...
  let n″≡n′ = whrDet*Term (redₜ d₁ , ne x₂) (redₜ d , ne neN′)
      ...
      ⊢σF≡σ′F = escapeEq [σF] (proj₂ ([F] {σ = liftSubst σ} (⊢Δ ∙ ⊢ℕ)
                                      ...
                                      (liftSubstS {F = ℕ} [Γ] ⊢Δ [ℕ] [σ′])
                                      (liftSubstSEq {F = ℕ} [Γ] ⊢Δ [ℕ] [σ] [σ≡σ′]))
      ⊢σz≡σ′z = PE.subst (λ x → _ ⊢ _ ≅ _ ∷ x ^ [ % , _ ]) (singleSubstLift F zero)
                         (escapeTermEq (proj₁ ([F₀] ⊢Δ [σ]))
                                          (proj₂ ([z] ⊢Δ [σ]) [σ′] [σ≡σ′]))
      ⊢σs≡σ′s = PE.subst (λ x → Δ ⊢ subst σ s ≅ subst σ′ s ∷ x ^ [ % , ι lF ])
                         (natrecSucCase σ F % lF)
...
-- Refuting cases
natrec-congTerm rFlF [Γ] [F] [F′] [F≡F′] [F₀] [F′₀] [F₀≡F′₀] [F₊] [F′₊] [F₊≡F′₊]
                [z] [z′] [z≡z′] [s] [s′] [s≡s′] ⊢Δ [σ] [σ′] [σ≡σ′]
                [σn] (ℕₜ _ d₁ _ zeroᵣ)
...
natrecᵛ : ∀ {F rF lF z s n Γ l}
        ...
        → Γ ⊩ᵛ⟨ l ⟩ s ∷ Π ℕ ^ ! ° ⁰ ▹ (F ^ rF ° lF ▹▹ F [ suc (var 0) ]↑ ° lF ° lF ^ rF ) ° lF ° lF ^ rF ^ [ rF , ι lF ] / [Γ] / [F₊]
        → ([n] : Γ ⊩ᵛ⟨ l ⟩ n ∷ ℕ ^ [ ! , ι ⁰ ] / [Γ] / [ℕ])
        → Γ ⊩ᵛ⟨ l ⟩ natrec lF F z s n ∷ F [ n ] ^ [ rF , ι lF ] / [Γ] / [Fₙ]
natrecᵛ {F} {rF} {lF} {z} {s} {n} {l = l} rFlF  [Γ] [ℕ] [F] [F₀] [F₊] [Fₙ] [z] [s] [n]
        {Δ = Δ} {σ = σ} ⊢Δ [σ] =
  let [F]′ = S.irrelevance {A = F} (_∙_ {A = ℕ} [Γ] [ℕ])
                           (_∙_ {l = l} [Γ] (ℕᵛ [Γ])) [F]
      [σn]′ = irrelevanceTerm {l′ = l} (proj₁ ([ℕ] ⊢Δ [σ]))
                              (ℕᵣ (idRed:*: (univ (ℕⱼ ⊢Δ)))) (proj₁ ([n] ⊢Δ [σ]))
      n′ = subst σ n
  ...
  in  irrelevanceTerm′ eqPrf PE.refl PE.refl (irrelevance′ (PE.sym (singleSubstComp n′ σ F))
                                           (proj₁ ([F]′ ⊢Δ ([σ] , [σn]′))))
                        (proj₁ ([Fₙ] ⊢Δ [σ]))
                   (natrecTerm {F} {rF} {lF} {z} {s} {n′} {σ = σ} rFlF [Γ]
                               [F]′
                               [F₀] [F₊] [z] [s] ⊢Δ [σ]
                               [σn]′)
 ,   (λ {σ′} [σ′] [σ≡σ′] →
        ...
        in  irrelevanceEqTerm′ eqPrf PE.refl PE.refl
              (irrelevance′ (PE.sym (singleSubstComp n′ σ F))
                            (proj₁ ([F]′ ⊢Δ ([σ] , [σn]′))))
              (proj₁ ([Fₙ] ⊢Δ [σ]))
              (natrec-congTerm {F} {F} {rF} {lF} {z} {z} {s} {s} {n′} {subst σ′ n} {σ = σ} rFlF 
                               [Γ] [F]′ [F]′ (reflᵛ {F} (_∙_ {A = ℕ} {l = l}
                               [Γ] (ℕᵛ [Γ])) [F]′) [F₀] [F₀]
                               (reflᵛ {F [ zero ]} [Γ] [F₀]) [F₊] [F₊]
                               (reflᵛ {Π ℕ ^ ! ° ⁰ ▹ (F ^ rF ° lF ▹▹ F [ suc (var 0) ]↑ ° lF ° lF ^ rF) ° lF ° lF ^ rF}
                                      [Γ] [F₊])
                               [z] [z] (reflᵗᵛ {F [ zero ]} {z} [Γ] [F₀] [z])
                               [s] [s]
                               (reflᵗᵛ {Π ℕ ^ ! ° ⁰ ▹ (F ^ rF ° lF ▹▹ F [ suc (var 0) ]↑ ° lF ° lF ^ rF ) ° lF ° lF ^ rF} {s}
                                       [Γ] [F₊] [s])
                               ⊢Δ [σ] [σ′] [σ≡σ′] [σn]′ [σ′n]′ [σn≡σ′n]))

-- Validity of natural recursion congruence.
natrec-congᵛ : ∀ {F F′ rF lF z z′ s s′ n n′ Γ l}
          (rFlF : rF PE.≡ % → lF PE.≡ ⁰)
          ([Γ] : ⊩ᵛ Γ)
          ([ℕ]  : Γ ⊩ᵛ⟨ l ⟩ ℕ ^ [ ! , ι ⁰ ] / [Γ])
          ([F]  : Γ ∙ ℕ ^ [ ! , ι ⁰ ] ⊩ᵛ⟨ l ⟩ F ^ [ rF , ι lF ] / [Γ] ∙ [ℕ])
          ...
          ([F′₊] : Γ ⊩ᵛ⟨ l ⟩ Π ℕ ^ ! ° ⁰ ▹ (F′ ^ rF ° lF ▹▹ F′ [ suc (var 0) ]↑ ° lF  ° lF ^ rF) ° lF ° lF ^ rF ^ [ rF , ι lF ] / [Γ])
          ([F₊≡F′₊] : Γ ⊩ᵛ⟨ l ⟩ Π ℕ ^ ! ° ⁰ ▹ (F ^ rF ° lF ▹▹ F [ suc (var 0) ]↑ ° lF ° lF ^ rF ) ° lF ° lF ^ rF
                              ≡ Π ℕ ^ ! ° ⁰ ▹ (F′ ^ rF ° lF ▹▹ F′ [ suc (var 0) ]↑ ° lF  ° lF ^ rF) ° lF ° lF ^ rF ^ [ rF , ι lF ] / [Γ]
                              / [F₊])
          ([Fₙ] : Γ ⊩ᵛ⟨ l ⟩ F [ n ] ^ [ rF , ι lF ] / [Γ])
          ([z] : Γ ⊩ᵛ⟨ l ⟩ z ∷ F [ zero ] ^ [ rF , ι lF ] / [Γ] / [F₀])
          ([z′] : Γ ⊩ᵛ⟨ l ⟩ z′ ∷ F′ [ zero ] ^ [ rF , ι lF ] / [Γ] / [F′₀])
          ([z≡z′] : Γ ⊩ᵛ⟨ l ⟩ z ≡ z′ ∷ F [ zero ] ^ [ rF , ι lF ] / [Γ] / [F₀])
          ([s] : Γ ⊩ᵛ⟨ l ⟩ s ∷ Π ℕ ^ ! ° ⁰ ▹ (F ^ rF ° lF ▹▹ F [ suc (var 0) ]↑ ° lF ° lF ^ rF ) ° lF ° lF ^ rF ^ [ rF , ι lF ] / [Γ] / [F₊])
          ([s′] : Γ ⊩ᵛ⟨ l ⟩ s′ ∷ Π ℕ ^ ! ° ⁰ ▹ (F′ ^ rF ° lF ▹▹ F′ [ suc (var 0) ]↑ ° lF ° lF ^ rF ) ° lF ° lF ^ rF ^ [ rF , ι lF ] / [Γ]
                           / [F′₊])
          ([s≡s′] : Γ ⊩ᵛ⟨ l ⟩ s ≡ s′ ∷ Π ℕ ^ ! ° ⁰ ▹ (F ^ rF ° lF ▹▹ F [ suc (var 0) ]↑ ° lF ° lF ^ rF ) ° lF ° lF ^ rF ^ [ rF , ι lF ] / [Γ] / [F₊])
          ([n] : Γ ⊩ᵛ⟨ l ⟩ n ∷ ℕ ^ [ ! , ι ⁰ ] / [Γ] / [ℕ])
          ([n′] : Γ ⊩ᵛ⟨ l ⟩ n′ ∷ ℕ ^ [ ! , ι ⁰ ] / [Γ] / [ℕ])
          ([n≡n′] : Γ ⊩ᵛ⟨ l ⟩ n ≡ n′ ∷ ℕ ^ [ ! , ι ⁰ ] / [Γ] / [ℕ])
        → Γ ⊩ᵛ⟨ l ⟩ natrec lF F z s n ≡ natrec lF F′ z′ s′ n′ ∷ F [ n ] ^ [ rF , ι lF ] / [Γ] / [Fₙ]
natrec-congᵛ {F} {F′} {rF} {lF} {z} {z′} {s} {s′} {n} {n′} {l = l} rFlF
