...
Uᵛgen∞ : ∀ {Γ rU lU} → ([Γ] : ⊩ᵛ Γ)
     → Γ ⊩ᵛ⟨ ∞ ⟩ Univ rU lU ^ [ ! , next lU ] / [Γ]
Uᵛgen∞ {Γ} {rU} {⁰} [Γ] = Uᵛgen (<is≤ 0<1) ∞< [Γ]
Uᵛgen∞ {Γ} {rU} {¹} [Γ] = Uᵛgen (≡is≤ PE.refl) ∞< [Γ]
...
Uᵗᵛ : ∀ {Γ l l' rU} → (l < l') → ([Γ] : ⊩ᵛ Γ) → Γ ⊩ᵛ⟨ ∞ ⟩ Univ rU l ∷ Univ ! l' ^ [ ! , next l' ] / [Γ] / Uᵛgen∞ [Γ]
Uᵗᵛ {Γ} {l} {l'} {rU} 0<1 [Γ] = λ ⊢Δ [σ] → Uᵗᵛ₁ ⊢Δ
