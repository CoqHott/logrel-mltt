...
univEqEq′ : ∀ {l l′ Γ A B r} ([U] : Γ ⊩⟨ l ⟩U) ([A] : Γ ⊩⟨ l′ ⟩ A ^ r)
         → Γ ⊩⟨ l ⟩ A ≡ B ∷ Univ r ^ ! / U-intr [U]
         → Γ ⊩⟨ l′ ⟩ A ≡ B  ^ r / [A]
...
univEqEq : ∀ {l l′ Γ A B r} ([U] : Γ ⊩⟨ l ⟩ Univ r ^ !) ([A] : Γ ⊩⟨ l′ ⟩ A ^ r)
         → Γ ⊩⟨ l ⟩ A ≡ B ∷ Univ r ^ ! / [U]
         → Γ ⊩⟨ l′ ⟩ A ≡ B ^ r / [A]
univEqEq [U] [A] [A≡B] =
