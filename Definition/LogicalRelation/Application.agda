...
appTerm : ∀ {F G t u Γ rF rF' l l′ l″} (eqr : rF PE.≡ rF')
          ([F] : Γ ⊩⟨ l″ ⟩ F ^ rF)
          ([G[u]] : Γ ⊩⟨ l′ ⟩ G [ u ] ^ !)
          ([ΠFG] : Γ ⊩⟨ l ⟩ Π F ^ rF' ▹ G ^ !)
          ([t] : Γ ⊩⟨ l ⟩ t ∷ Π F ^ rF' ▹ G ^ ! / [ΠFG])
          ([u] : Γ ⊩⟨ l″ ⟩ u ∷ F ^ rF / [F])
        → Γ ⊩⟨ l′ ⟩ t ∘ u ∷ G [ u ] ^ ! / [G[u]]
...
app-congTerm′ : ∀ {F G t t′ u u′ Γ rF l l′}
          ([F] : Γ ⊩⟨ l′ ⟩ F ^ rF)
          ([G[u]] : Γ ⊩⟨ l′ ⟩ G [ u ] ^ !)
          ([ΠFG] : Γ ⊩⟨ l ⟩Π Π F ^ rF ▹ G ^ !)
          ([t≡t′] : Γ ⊩⟨ l ⟩ t ≡ t′ ∷ Π F ^ rF ▹ G ^ ! / Π-intr [ΠFG])
          ([u] : Γ ⊩⟨ l′ ⟩ u ∷ F ^ rF / [F])
          ([u′] : Γ ⊩⟨ l′ ⟩ u′ ∷ F ^ rF / [F])
          ([u≡u′] : Γ ⊩⟨ l′ ⟩ u ≡ u′ ∷ F ^ rF / [F])
        → Γ ⊩⟨ l′ ⟩ t ∘ u ≡ t′ ∘ u′ ∷ G [ u ] ^ ! / [G[u]]
app-congTerm′ {F′} {G′} {t = t} {t′ = t′} {Γ = Γ} {rF = rF}
